...
using System;
using PhotoGalleryManager.App_Start;
using PhotoGalleryManager.Utils;
using PhotoGalleryManager.Config;
using PhotoGalleryManager.Services;
using PhotoGalleryManager.Auth;
using PhotoGalleryManager.Filters;
...
namespace PhotoGalleryManager
{
    public class ApiConfiguration
    {
        public static void Install(HttpConfiguration config, IAppBuilder app)
        {
            ...
            config
                .EnableSwagger(c => c.SingleApiVersion("v1", "PhotoGalleryManager"))
                .EnableSwaggerUi();
